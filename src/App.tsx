...
function PetraMark(){return <svg className="networkLogo petraLogo" viewBox="0 0 32 32" aria-hidden="true"><rect width="32" height="32" rx="6" fill="#6b38ff"/><path fill="#fff" d="M7 9.2A8.8 8.8 0 0 1 15.8 4h7.8l-7.2 7.2H14v8.1H7V9.2Zm9.4 2h7.2l-3.5 3.5 4.4 4.4-5 5-7.9-7.9 4.8-5Z"/></svg>}

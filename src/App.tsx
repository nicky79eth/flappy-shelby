...
function PetraMark(){return <svg className="networkLogo petraLogo" viewBox="0 0 100 100" aria-hidden="true"><rect width="100" height="100" rx="18" fill="#6C3BFF"/><path fill="#fff" d="M18 34C18 22.95 26.95 14 38 14h39L61 30H45v28H18V34Z"/><path fill="#fff" d="m45 58 17-17 20 20-27 27-20-20 10-10Z"/></svg>}
